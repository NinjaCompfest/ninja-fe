...
import ProgramConfirmationDetailInfo from "./components/ProgramConfirmationDetailInfo";
    ...
    render() {
        return (
            <div className="bg-gray-300 min-h-screen">
                ...
                <ProgramConfirmationDetailInfo title={this.state.title} desc={this.state.desc} fullname={this.state.fullname} />
            </div>
        );
    }
}
